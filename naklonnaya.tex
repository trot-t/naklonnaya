...
\begin{onehalfspacing}
	\begin{array}{l}	
		F^1(x_1,x_2) = - \sin\alpha\cdot x_1 + \cos\alpha\cdot x_2 = 0 = q^1 - \textcyrillic{уравнение связи,} \\ 
%\\
		F^2(x_1,x_2) = x_2 = q^2 - \textcyrillic{свободная переменная}
	\end{array}
\end{onehalfspacing}	
%\endgroup
\right.  
